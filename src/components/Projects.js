...
export default function Projects({ forwardRef }) {
  ...
  return (
    <section className="projects-section">
      ...
      <h2 className="projects-text text-medium text-center" data-aos="fade-up">
        Projects
      </h2>
      <div className="projects-wrapper">
        <div className="projects-item left">
          <img
            src={VideoCallImage}
            alt="mockup of videocall website"
            className="projects-img left"
            data-aos={fadeRight}
          />
          <img
            src={VideoCallImageSmallScreens}
            alt="mockup of videocall website"
            className="projects-img small"
            data-aos={fadeRight}
          />

          <h3 className="project-name text-small center" data-aos={fadeRight}>
            VideoCall
          </h3>
          ...
          <div className="button-wrapper" data-aos={fadeRight}>
            <a
              className="button"
              href="https://github.com/FilipKujavec/videocall"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              className="button"
              href="https://videocall.kujavec.com"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div className="projects-item">
          <img
            src={RecipeImage}
            alt="mockup of recipes website"
            className="projects-img right"
            data-aos={fadeLeft}
          />
          <img
            src={RecipeImageSmallScreens}
            alt="mockup of recipes website"
            className="projects-img small"
            data-aos={fadeLeft}
          />

          <h3 className="project-name text-small center" data-aos={fadeLeft}>
            Recipes
          </h3>
          ...
          <div className="button-wrapper" data-aos={fadeLeft}>
            <a
              className="button"
              href="https://github.com/FilipKujavec/recipes"
              target="_blank"
              rel="noreferrer"
            >
              <i className="button-icon devicon-github-original"></i>
            ...
            <a
              className="button"
              href="https://recipes.kujavec.com"
              target="_blank"
              rel="noreferrer"
            >
              <i className="button-icon material-icons-outlined">play_arrow</i>
